...
**Violating the latter is violating the spirit of the rules.**
...
- [ ] All tests pass
- [ ] Output pristine (no errors, warnings in lsp)
- [ ] Tests use real code (mocks only if unavoidable)
- [ ] Edge cases and errors covered
- [ ] typecheck and linting passes
